  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="rounded-xl border-2 border-dashed border-white/[0.08] bg-white/[0.01] p-12 text-center mb-6 hover:border-brand-500/20 hover:bg-brand-500/[0.02] transition-colors cursor-not-allowed">
        <Upload className="w-8 h-8 text-brand-100/20 mx-auto mb-3" />
        ...
        <span className="inline-block mt-4 text-[10px] px-2.5 py-1 rounded-full border border-white/[0.06] bg-white/[0.02] text-brand-100/30">
          Coming soon
        </span>
      </div>
      ...
      <div className="rounded-xl border border-white/[0.06] overflow-hidden">
        ...
        <div className="py-14 text-center">
          <Paperclip className="w-7 h-7 text-brand-100/20 mx-auto mb-3" />
          <p className="text-sm text-brand-100/40">No files attached</p>
          <p className="text-xs text-brand-100/25 mt-1">
