...
- **Deploys are manual; the live site can lag the repo.** Latest prod deploy: **`oracle-qenuah90n`** (2026-08-21, comps building-grade + State column), both domains aliased.
